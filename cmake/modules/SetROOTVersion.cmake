...
function(SET_VERSION_FROM_FILE)
  ...
  if(ROOT_BASE_DIR AND EXISTS ${ROOT_BASE_DIR}/include/ROOT/RVersion.hxx)
	  file(READ "${ROOT_BASE_DIR}/include/ROOT/RVersion.hxx" versionstr)
  elseif(ROOT_MAIN_SOURCE_DIR AND EXISTS ${ROOT_MAIN_SOURCE_DIR}/include/ROOT/RVersion.hxx)
    file(READ "${ROOT_MAIN_SOURCE_DIR}/core/foundation/inc/ROOT/RVersion.hxx" versionstr)
  else()
