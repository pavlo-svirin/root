  ...
  foreach(DEP ${ARG_DEPENDENCIES})
    ...
    if(DEP_EXISTS EQUAL 0)
	 ...
	 set_property(TARGET ${DEP} PROPERTY IMPORTED_LOCATION ${ROOT_BASE_DIR}/lib/lib${DEP}.so)
       elseif(ROOT_MAIN_BINARY_DIR AND ROOT_MAIN_BINARY_DIR/lib/lib${DEP}.so)
         add_library(${DEP} SHARED IMPORTED)
        set_property(TARGET ${DEP} PROPERTY IMPORTED_LOCATION ${ROOT_MAIN_BINARY_DIR}/lib/lib${DEP}.so)
       endif()
    endif()
  endforeach()
